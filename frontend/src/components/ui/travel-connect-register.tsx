...
// ─── DotMap (same as login) ──────────────────────────────────────────────────

type RoutePoint = { x: number; y: number; delay: number };

const routes: { start: RoutePoint; end: RoutePoint; color: string }[] = [
  { start: { x: 80,  y: 160, delay: 0 },   end: { x: 190, y: 90,  delay: 2 },   color: "#2563eb" },
  { start: { x: 190, y: 90,  delay: 2 },   end: { x: 250, y: 130, delay: 4 },   color: "#2563eb" },
  { start: { x: 40,  y: 60,  delay: 1 },   end: { x: 140, y: 185, delay: 3 },   color: "#2563eb" },
  { start: { x: 270, y: 50,  delay: 0.5 }, end: { x: 170, y: 175, delay: 2.5 }, color: "#2563eb" },
];
...
export const TravelConnectRegister = () => {
        ...
        <div className="hidden md:block w-1/2 h-150 relative overflow-hidden border-r border-gray-100">
          <div className="absolute inset-0 bg-linear-to-br from-blue-50 to-indigo-100">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center p-8 z-10">
              ...
              >
                Create your account and access your secure workspace in seconds
              </motion.p>
            </div>
          </div>
        </div>
